class DateHelper {
    ...
    static textoParaData(texto) {
        ...
        return new Date(...texto.split('/').reverse().map((item, indice) => item - indice % 2)); //quando usar arrow function e tiver somente uma linha não necessita de (function, {} e return)
    }
}